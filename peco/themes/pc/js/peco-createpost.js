...
function initDialog() {
	...
	$videoSearchDialog = $( "#videoSearchPopUp" ).dialog({
	      ...
	      open: function(event, ui) {	    	  
	    	  ...
	    	  $('html').width($('body').width());
	    	  $('html').css('overflow-y','hidden');
	    	  //$("#videoSearchTab").removeClass("ui-widget-content");
	      },
	      beforeClose: function(event, ui) {	    	  
    		  //$(event.target).parent().css("position","fixed");	    	
	    	  $('html').removeAttr('style')
	...
	$(".ui-widget-header").css("border-top", "none");
	$(".ui-widget-header").css("border-left", "none");
	$(".ui-widget-header").css("border-right", "none");
